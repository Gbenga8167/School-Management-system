...
class TeacherCheckResultPerClass extends Controller
{
   public function ShowReportSelectForm(){
        ...
        return view('backend.teacher_account.report.report_card_form_selector', 
    ...
    public function Index(){
        ...
        return view('backend.teacher_account.report.report_card', [

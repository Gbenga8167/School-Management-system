...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">CREATE CLASSES</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control @error('class_name') is-invalid @enderror" name="class_name"  type="text" placeholder="Class Name" >
                        <p style="font-style:italic;">Eg- class one, class two, class three...</p>
                        @error('class_name')

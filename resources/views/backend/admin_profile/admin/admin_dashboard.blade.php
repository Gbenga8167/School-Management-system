...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <div id="layout-wrapper">
          ...
          @include('backend.admin_profile.admin.sections.header')

            <!-- ========== Left Sidebar Start ========== -->
           
            @include('backend.admin_profile.admin.sections.sidebar')
            ...
            <div class="main-content">
                ...
                @include('backend.admin_profile.admin.sections.footer')

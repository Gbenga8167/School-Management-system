...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <div id="layout-wrapper">
          ...
          @include('backend.teacher_account.sections.header')

            <!-- ========== Left Sidebar Start ========== -->
           
            @include('backend.teacher_account.sections.teacher_sidebar')
            ...
            <div class="main-content">
                ...
                @include('backend.teacher_account.sections.footer')

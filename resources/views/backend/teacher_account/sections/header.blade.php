                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    ...
                                    <a href="" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <img src="{{asset('../BackendTem/assets/images/users/avatar-3.jpg')}}"
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ empty($teacherphoto->photo)? asset('uploads/no_image.png') : asset('uploads/teachers_photos/'.$teacherphoto->photo)}}" 
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1" style="">{{ $TeacherData->name}}</span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="{{route('teacher.profile')}}"><i class="ri-user-line align-middle me-1"></i> Profile</a>

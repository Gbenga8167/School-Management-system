...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">TEACHER'S PASSWORD CHANGE</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Teacher Password - Update </h4>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control @error('old_password') is-invalid @enderror" name="old_password" type="password" placeholder="Old_Password">
                ...
                <div class="row mb-3">
                    <label for="example-search-input" class="col-sm-2 col-form-label">Confirm New Password</label>
                    <div class="col-sm-10">

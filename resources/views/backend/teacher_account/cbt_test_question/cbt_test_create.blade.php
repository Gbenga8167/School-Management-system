            ...
            @if(session('success'))
             ...
             <h4 class="card-title">CBT Tests</h4>
                ...
                @csrf
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="title" required placeholder="CBT Title">
                    </div>
                   </div>
                   <!-- end row -->
                ...
                <div class="row mb-3">
                   ...
                   <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="duration_minutes" required placeholder="Duration">
                    </div>
                    </div>
                   <!-- end row -->
                   ...
                   <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                    <select  name="assessment_type" required class="form-select" aria-label="Default select example">
